...
| Próximo passo | Guia |
| --- | --- |
| Instalar | [Guia de instalação](installation.md) |
| Usar com uma IA | [Guia operacional](ai-agent-operating-guide.md) |
| Entender o contexto | [Economia de contexto](context-economy.md) |
| Organizar um projeto | [Hierarquia DEV](project-dev-hierarchy.md) |
