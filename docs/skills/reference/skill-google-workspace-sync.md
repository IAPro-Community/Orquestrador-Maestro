...
Google Workspace sync patterns for Drive/Sheets/Calendar data, OAuth scopes, webhooks, and reconciliation.
...
| Tags | integrations, google, workspace, sync |
...
- Use para google workspace.
- Use para google drive.
- Use para google sheets.
- Use para google calendar.
- Use para workspace sync.
...
- Chain `skill-ai-orchestration`
- Chain `skill-google-workspace-sync`
...
- Upstream: local-integration-patterns
- Versão: bundled
- Licença: repository-license
- Steward: orquestrador-maintainers
- Revisado em: 2026-09-13
- Evidências: `orquestrador/skills/skill-google-workspace-sync/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-google-workspace-sync/SKILL.md`](../../../orquestrador/skills/skill-google-workspace-sync/SKILL.md)
