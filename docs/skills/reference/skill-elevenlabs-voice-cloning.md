...
ElevenLabs voice generation/cloning integration with consent, asset handling, and server-side API use.
...
| Tags | ai, elevenlabs, voice, cloning |
...
- Use para elevenlabs.
- Use para voice cloning.
- Use para clonar voz.
- Use para tts.
- Use para text to speech.
...
- Evidências: `orquestrador/skills/skill-elevenlabs-voice-cloning/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-elevenlabs-voice-cloning/SKILL.md`](../../../orquestrador/skills/skill-elevenlabs-voice-cloning/SKILL.md)
