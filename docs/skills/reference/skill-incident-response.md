...
Resposta a incidentes, contenção, recuperação e postmortem.
...
- Evidências: `orquestrador/skills/skill-incident-response/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-incident-response/SKILL.md`](../../../orquestrador/skills/skill-incident-response/SKILL.md)
