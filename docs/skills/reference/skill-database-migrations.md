...
Migrações de banco seguras, compatíveis, idempotentes e verificáveis.
...
- Use para database migration.
- Use para migração de banco.
- Use para migration sql.
...
- Evidências: `orquestrador/skills/skill-database-migrations/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-database-migrations/SKILL.md`](../../../orquestrador/skills/skill-database-migrations/SKILL.md)
