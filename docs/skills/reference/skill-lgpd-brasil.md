...
| Tags | compliance, lgpd, brasil |
| Aliases | lgpd, lgpd brasil, lei geral de protecao de dados, anpd, ripd, dpo, encarregado lgpd |
...
- Use para lgpd.
- Use para lgpd brasil.
- Use para lei geral de protecao de dados.
- Use para anpd.
- Use para ripd.
...
- Upstream: local-privacy-patterns
- Versão: bundled
- Licença: repository-license
- Steward: orquestrador-maintainers
- Revisado em: 2026-09-13
- Evidências: `orquestrador/skills/skill-lgpd-brasil/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-lgpd-brasil/SKILL.md`](../../../orquestrador/skills/skill-lgpd-brasil/SKILL.md)
