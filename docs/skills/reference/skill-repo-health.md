...
Diagnóstico de saúde, stack, verificação e riscos de repositórios.
...
| Tags | engineering, repo, health |
| Aliases | repo health, health check repositorio |
...
- Use para repo health.
- Use para saúde do repositorio.
- Use para inspecionar repositorio.
...
- Evidências: `orquestrador/skills/skill-repo-health/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-repo-health/SKILL.md`](../../../orquestrador/skills/skill-repo-health/SKILL.md)
