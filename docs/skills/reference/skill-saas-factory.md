...
Top-level SaaS construction and review workflow for dashboards, admin, Supabase, payments, security, infra, and production readiness.
...
- Use para criar saas.
- Use para novo saas.
- Use para saas factory.
- Use para dashboard saas.
- Use para admin dashboard.
...
- Evidências: `orquestrador/skills/skill-saas-factory/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-saas-factory/SKILL.md`](../../../orquestrador/skills/skill-saas-factory/SKILL.md)
