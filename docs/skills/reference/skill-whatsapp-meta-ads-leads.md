...
# skill-whatsapp-meta-ads-leads

Configura campanhas de WhatsApp no Meta Ads para gerar leads qualificados para negócios locais.
...
| Tags | marketing, whatsapp, meta, ads, leads |
| Aliases | whatsapp meta ads leads, campanha whatsapp, meta ads whatsapp |
...
- Use para whatsapp meta ads.
- Use para campanha de whatsapp.
- Use para leads qualificados whatsapp.
- Use para meta ads para negócios locais.
...
- Upstream: filipe-detrey-campanha-whatsapp-2026
- Versão: bundled
- Licença: repository-license
- Steward: orquestrador-maintainers
- Revisado em: 2026-08-06
- Evidências: `orquestrador/skills/skill-whatsapp-meta-ads-leads/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-whatsapp-meta-ads-leads/SKILL.md`](../../../orquestrador/skills/skill-whatsapp-meta-ads-leads/SKILL.md)
