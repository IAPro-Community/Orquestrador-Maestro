...
Pesquisa web rastreável, comparável e baseada em fontes primárias.
...
| Tags | research, and, synthesis |
| Aliases | pesquisa com fontes |
...
- Use para research and synthesis.
- Use para pesquisa web.
- Use para pesquisar e sintetizar.
...
- Evidências: `orquestrador/skills/skill-research-and-synthesis/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-research-and-synthesis/SKILL.md`](../../../orquestrador/skills/skill-research-and-synthesis/SKILL.md)
