...
Observabilidade de agentes, custos, latência, qualidade e regressões.
...
- Use para agent observability.
- Use para observabilidade de agente.
- Use para tracing agente.
...
- Evidências: `orquestrador/skills/skill-agent-observability/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-agent-observability/SKILL.md`](../../../orquestrador/skills/skill-agent-observability/SKILL.md)
