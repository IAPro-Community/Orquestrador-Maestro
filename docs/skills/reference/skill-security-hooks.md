...
Git hooks and CI security gates for SaaS repositories.
...
- Use para security hooks.
- Use para pre-commit.
- Use para pre-push.
- Use para ci security.
- Use para security gate.
...
- Evidências: `orquestrador/skills/skill-security-hooks/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-security-hooks/SKILL.md`](../../../orquestrador/skills/skill-security-hooks/SKILL.md)
