...
Clonagem de uma página web por URL com extração de estrutura, reprodução visual, interações essenciais e verificação no navegador.
...
| Tags | frontend, web, clone |
| Aliases | clone site, clonar site, web clone |
...
- Use para web-clone.
- Use para clone site.
- Use para clone website.
- Use para clonar site.
...
- Upstream: codex-native-web-clone
- Versão: bundled
- Licença: repository-license
- Steward: orquestrador-maintainers
- Revisado em: 2026-09-13
- Evidências: `orquestrador/skills/skill-web-clone/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-web-clone/SKILL.md`](../../../orquestrador/skills/skill-web-clone/SKILL.md)
