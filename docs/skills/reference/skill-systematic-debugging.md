...
Debugging sistemático orientado por evidência e causa raiz.
...
| Tags | engineering, systematic, debugging |
| Aliases | debug sistematico |
...
- Use para debug sistematico.
- Use para causa raiz.
- Use para investigar bug.
...
- Evidências: `orquestrador/skills/skill-systematic-debugging/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-systematic-debugging/SKILL.md`](../../../orquestrador/skills/skill-systematic-debugging/SKILL.md)
