...
AbacatePay PIX/card billing, CPF/CNPJ, BRL checkout, billing webhooks, and entitlement sync.
...
| Tags | payments, abacatepay, integration |
...
- Evidências: `orquestrador/skills/skill-abacatepay-integration/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-abacatepay-integration/SKILL.md`](../../../orquestrador/skills/skill-abacatepay-integration/SKILL.md)
