...
Testes web E2E, acessibilidade, estados e regressão visual.
...
- Use para webapp testing.
- Use para teste e2e.
- Use para teste E2E.
- Use para teste de aplicação web.
...
- Evidências: `orquestrador/skills/skill-webapp-testing/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-webapp-testing/SKILL.md`](../../../orquestrador/skills/skill-webapp-testing/SKILL.md)
