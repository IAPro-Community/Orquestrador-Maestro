...
Video, audio, screen-recording, and visual-flow analysis with persistent indexes, timestamped evidence, OCR/transcription, and deterministic verification.
...
| Tags | media, watch, evidence |
| Aliases | watch skill, watch-skill, assistir vídeo, evidência de vídeo, memória de vídeo, loop visual, prova visual |
...
- Use para watch skill.
- Use para watch-skill.
- Use para watch this video.
- Use para assistir vídeo.
- Use para assistir video.
...
- Upstream: adapted-external-oxbshw-watch-skill-1.4.2
- Versão: bundled
- Licença: repository-license
- Steward: orquestrador-maintainers
- Revisado em: 2026-09-13
- Evidências: `orquestrador/skills/skill-watch-evidence/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-watch-evidence/SKILL.md`](../../../orquestrador/skills/skill-watch-evidence/SKILL.md)
