...
Construção segura de MCP servers tipados e testáveis.
...
- Use para mcp builder.
- Use para criar mcp.
- Use para servidor mcp.
...
- Evidências: `orquestrador/skills/skill-mcp-builder/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-mcp-builder/SKILL.md`](../../../orquestrador/skills/skill-mcp-builder/SKILL.md)
