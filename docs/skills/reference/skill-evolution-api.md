...
Evolution API WhatsApp integration with webhook idempotency, queueing, consent, and rate limits.
...
| Tags | communication, evolution, api |
| Aliases | evolution api |
...
- Use para evolution api.
- Use para whatsapp.
- Use para webhook whatsapp.
- Use para instancia whatsapp.
- Use para qr code whatsapp.
...
- Evidências: `orquestrador/skills/skill-evolution-api/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-evolution-api/SKILL.md`](../../../orquestrador/skills/skill-evolution-api/SKILL.md)
