...
Unified SaaS/product analytics event taxonomy, metrics, funnels, dashboards, and privacy guardrails.
...
- Use para analytics.
- Use para event tracking.
- Use para metrics.
- Use para funnels.
- Use para dashboard metrics.
...
- Recipe `ai-with-observability`: Integração de IA com observabilidade
- Chain `skill-ai-orchestration`
- Chain `skill-evolution-api`
...
- Upstream: local-analytics-patterns
- Versão: bundled
- Licença: repository-license
- Steward: orquestrador-maintainers
- Revisado em: 2026-09-13
- Evidências: `orquestrador/skills/skill-unified-analytics/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-unified-analytics/SKILL.md`](../../../orquestrador/skills/skill-unified-analytics/SKILL.md)
