...
Safe AionUi cowork/team integration around Codex, Claude, Gemini, OpenCode, MCPs, and the user orchestrator without replacing the existing workflow.
...
| Tags | orchestration, aionui, cowork |
...
- Evidências: `orquestrador/skills/skill-aionui-cowork-orchestration/SKILL.md`

## Fonte canônica

[`orquestrador/skills/skill-aionui-cowork-orchestration/SKILL.md`](../../../orquestrador/skills/skill-aionui-cowork-orchestration/SKILL.md)
