        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    ...
                    var proc = (0, node_child_process_1.spawn)(command, args, {
                        cwd: opts.cwd,
                        timeout: (_a = opts.timeout) !== null && _a !== void 0 ? _a : 10000,
                        stdio: ['ignore', 'pipe', 'pipe'],
                    });
                    var stdout = '';
                    proc.stdout.on('data', function (d) { return (stdout += d.toString()); });
                    proc.on('close', function (code) { return resolve({ stdout: stdout, exitCode: code !== null && code !== void 0 ? code : 1 }); });
                    proc.on('error', function () { return resolve({ stdout: '', exitCode: 1 }); });
                })];
        });
    });
}
